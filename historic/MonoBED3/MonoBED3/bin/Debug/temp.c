...
extern const unsigned char assembly_data_MonoBED3_exe [];
static const MonoBundledAssembly assembly_bundle_MonoBED3_exe = {"MonoBED3.exe", assembly_data_MonoBED3_exe, 147968};

static const MonoBundledAssembly *bundled [] = {
	&assembly_bundle_MonoBED3_exe,
	NULL
};

static char *image_name = "MonoBED3.exe";

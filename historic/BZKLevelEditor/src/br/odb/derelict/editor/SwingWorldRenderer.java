...
import br.odb.gamelib.rendering.Rect;
 ...
 * @author monty
 */
public abstract class SwingWorldRenderer extends WorldRenderer {
    ...
    void prepareWith(Graphics g ) {
        bufferedGraphics = g;
        dimensions.x = container.getWidth();
        dimensions.y = container.getHeight();
    }
